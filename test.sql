...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2023 at 10:11 AM
...
(2, 'IPA-09', '198704252015122001', 'Crystal Widjaja, M.M.', 'crystal', '087829743123', 'Jl. Cihampelas No.160');
...
(1, 8, '112208801', 'Ziady Mubaraq', 'ziady', 'Jl. Negla Gg. Al Ikhlas No.21');
...
--
ALTER TABLE `kontrak`
  MODIFY `idKontrak` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
